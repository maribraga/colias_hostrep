...
# then add subroot branch (for RevBayes)
```
...
# writeLines(tree_geo_subroot_string, here("biogeography/with_zerene/data/tree_colias_geo_subroot.tre"))

```

#### Analysis WITHOUT Zerene (outgroup)
...
geo_data_matrix <- geo_data_matrix[,c("SEA","EPa","WPa","NAr","PTP","Afr","NTr")] 
```
...
# tree_geo_subroot_string <- sub(");$", "):0.01;", tree_geo_string)
# writeLines(tree_geo_subroot_string, here("biogeography/without_zerene/data/tree_colias_geo_subroot.tre"))
